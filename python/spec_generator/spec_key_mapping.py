...
def EventSpec(request, Response):
    ...
    return Response(json.dumps({"Message": "Spec not created", "SpecFile": EventName, "code": 400}))
...
def DimensionSpec(request, Response):
    ...
    return Response(json.dumps({"Message": "Spec not created", "SpecFile": DimensionName, "code": 400}))
...
def DatasetSpec(request, Response):
    ...
    return Response(json.dumps({"Message": "Spec not created", "SpecFile": DatasetName, "code": 400}))
