    ...
    try:
        ...
        for value in DatasetItems:
            ...
            for record in list(records):
                ...
                InputKeys.update({'AWSKey': '{}', 'AWSSecretKey': '{}', 'BucketName': '{}', 'ObjKey': '{}', 'Values': '{}','DateCasting':','.join(DateCasting),
        ...
        print(error)
    return Response(json.dumps({"Message": "transformer Not Created", "TransformerFile":Transformer}))
